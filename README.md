...
| `/sm-search <query>` | Search all memories by semantic similarity and show a results popup. Optional `k=N` sets the result count (default 10, max 50). Falls back to keyword overlap when the embedding model is unavailable. |
